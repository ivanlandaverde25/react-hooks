...
export const ScrambleWords = () => {
  ...
  // Todas los state para las palabras
  ...
  // Maximo intentos de errores
  const [maxAllowErrors, setMaxAllowErrors] = useState(3);

  // Cantidad de veces pasada la palabra
  const [skipCounter, setSkipCounter] = useState(0);

  // Maximo intentos de pasar
  ...
  const handleGuessSubmit = (e: React.FormEvent) => {
    ...
    // En el caso que la palabra si sea la correcta
    ...
    // Validar la cantidad de errores hasta el momento
